/******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    ...
    /***/ 303: /***/ function (
      ...
      const selfesrimation_1 = __importDefault(__webpack_require__(568));
      class App {
        constructor() {
    ...
    /***/ 225: /***/ (
      ...
      class Card {
        ...
        createDomCard() {
          ...
          domCardImage.src = `${definitions_1.PATH}${Number(this.num)}.png`;
        ...
        setEventListener() {
          ...
          domCards.onclick = (event) => {
            ...
            if (index >= 0) {
              ...
              if (
                definitions_1.CHOSEN_TOYS.length == definitions_1.CHOSEN_AMOUNT
              ) {
    ...
    /***/ 568: /***/ (__unused_webpack_module, exports) => {
      "use strict";
