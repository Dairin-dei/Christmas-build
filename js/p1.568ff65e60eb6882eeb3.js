/******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    ...
    /***/ 225: /***/ (
      ...
      class Card {
        ...
        createDomCard() {
          ...
          domCardFavorite.textContent = `Любимая: ${
    ...
    /***/ 195: /***/ (__unused_webpack_module, exports) => {
      "use strict";
      ...
      class DecorationParameters {
        ...
        showTrees() {
          ...
          for (let i = 1; i <= definitions_1.AMOUNT_OF_TREES; i++) {
            const newTree = new DecorationCard_1.default(
              i,
              `${definitions_1.PATH_TO_TREES}${i}.png`,
              "tree-card",
              "tree-card-image"
            );
        ...
        showBackgrounds() {
          ...
          for (let i = 1; i <= definitions_1.AMOUNT_OF_BACKGROUNDS; i++) {
            const newBackground = new DecorationCard_1.default(
              i,
              `${definitions_1.PATH_TO_BACKGROUNDS}${i}.jpg`,
              "background-card",
              "backgroung-image"
            );
        ...
        showChosenOrnaments() {
          ...
          if (definitions_1.CHOSEN_TOYS.length > 0) {
            for (let i = 0; i < definitions_1.CHOSEN_TOYS.length; i++) {
              const ornament = this.dataArray.find(
                (item) => item.num === definitions_1.CHOSEN_TOYS[i]
              );
            ...
            for (
              let i = definitions_1.CHOSEN_TOYS.length;
              i < definitions_1.CHOSEN_AMOUNT;
              i++
            ) {
          ...
          const domOrnamentsWrapper =
            document.querySelector(".ornaments-wrapper");
          domOrnamentsWrapper.innerHTML = "";
          this.ornamentsData.forEach((elem) => {
            const newOrnament = new DecorationCard_1.default(
              Number(elem.num),
              elem.num === "-1"
                ? ""
                : `${definitions_1.PATH_TO_TOYS}${elem.num}.png`,
              "toy-card",
              "toy-card-image",
              elem.amount
            );
        ...
        setEventListenerOnButtonSnow() {
          const buttonSnow = document.querySelector(".button-snow");
          buttonSnow.onclick = () => this.runSnowflakes();
        }
        ...
        setEventListenerOnTreeOrnaments() {
          ...
          const domArrayImages =
            domTreeContainer.querySelectorAll(".toy-card-image");
        ...
        drag(event, isCloningNeed) {
          ...
          ornament.ondragend = (event) => this.dragend(event);
        }
        dragleave(event) {
          event.preventDefault();
        }
        dragend(event) {
          if (toyMovedFromTree) {
            ...
            if (ornament) {
              ornament.remove();
              this.tree.changeTreeState(ornament, "remove");
            }
        ...
        drop(event) {
          ...
          const isCloningNeeded =
            event.dataTransfer.getData("text") === "true" ? true : false;
          event.preventDefault();
          const ornament = document.querySelector(".moving");
          ...
          ornament.style.left =
            event.clientX - coordTree.x - coord.width / 2 + "px";
          ornament.style.top =
            event.clientY - coordTree.y - coord.height / 2 + "px";
          ...
          if (isCloningNeeded) {
            ...
            cloneOrnament.ondragstart = (event) => this.drag(event, true);
        ...
        getItemsFromLocalStorage() {
          ...
          if (gotFilterShape) {
            ...
            tempConvert.forEach((elem) => {
              var _a;
              const instanceEShape =
                (_a = Object.entries(definitions_1.eShapes).find(
                  ([key, val]) => val === elem
                )) === null || _a === void 0
                  ? void 0
                  : _a[0];
          ...
          if (gotFilterColor) {
            ...
            tempConvert.forEach((elem) => {
              var _a;
              const instanceEColor =
                (_a = Object.entries(definitions_1.eColors).find(
                  ([key, val]) => val === elem
                )) === null || _a === void 0
                  ? void 0
                  : _a[0];
          ...
          if (gotFilterSize) {
            ...
            tempConvert.forEach((elem) => {
              var _a;
              const instanceESize =
                (_a = Object.entries(definitions_1.eSizes).find(
                  ([key, val]) => val === elem
                )) === null || _a === void 0
                  ? void 0
                  : _a[0];
          ...
          const gotFilterFavorite =
            localStorage.getItem("dd_filterFavorite") || "";
          if (gotFilterFavorite) {
            this.filters.filterFavorite =
              gotFilterFavorite === "true" ? true : false;
          }
          ...
          const gotSortingMethod =
            localStorage.getItem("dd_sortingMethod") || "";
          if (gotSortingMethod) {
            const instanceSortingMethod =
              (_a = Object.entries(definitions_1.eSortingMethod).find(
                ([key, val]) => val === gotSortingMethod
              )) === null || _a === void 0
                ? void 0
                : _a[0];
            this.sortingMethod =
    ...
    /***/ 338: /***/ (__unused_webpack_module, exports) => {
      ...
      class LocalStorageToys {
        ...
        setToLocalStorage() {
          localStorage.setItem(
            "dd_chosenToys",
            JSON.stringify(this.chosenToys)
          );
        }
        getItemsFromLocalStorage() {
    ...
    /***/ 812: /***/ (__unused_webpack_module, exports) => {
      ...
      class LocalStorageTree {
        ...
        getItemsFromLocalStorage() {
          ...
          const gotIsSnowOn = localStorage.getItem("dd_isSnowOn") || "";
          this.isSnowOn = gotIsSnowOn === "true" ? true : false;
        }
      }
      ...
      class Ornaments {
        ...
        placeAllCards(loadFromStorage) {
          ...
          domCardElements.forEach((elem) => {
            const dataNum = elem.querySelector(".card-num").textContent;
          ...
          domCards.onclick = (event) => {
            ...
            if (card) {
              ...
              if (index >= 0) {
                ...
                this.localStorageToys.setSettingsForSaving(
                  definitions_1.CHOSEN_TOYS
                );
              } else {
                if (
                  definitions_1.CHOSEN_TOYS.length ==
                  definitions_1.CHOSEN_AMOUNT
                ) {
                  const popupWindow = new Popup_1.default(
    ...
    /***/ 105: /***/ function (
      ...
      class Parameters {
        constructor() {
          ...
          this.localStorageFilters = new LocalStorageFilters_1.default(
            this.filters,
            this.sortingMethod,
            this.isMusicOn
          );
        ...
        addEventListenersOnShapeFilters() {
          ...
          const domShapeFilterButtons =
            domFilters.querySelectorAll(".button-shape");
        ...
        addEventListenersOnColorFilters() {
          ...
          const domColorFilterButtons =
            domFilters.querySelectorAll(".button-color");
        ...
        addEventListenersOnSizeFilters() {
          ...
          const domSizeFilterButtons =
            domFilters.querySelectorAll(".button-size");
        ...
        clearActiveClasses() {
          ...
          const domFiltersShape =
            domfilterSettings.querySelectorAll(".button-shape");
          domFiltersShape.forEach((elem) => {
            const domCurrentFilter = elem;
            domCurrentFilter.classList.remove("filters-active-button");
          });
          const domFiltersColor =
            domfilterSettings.querySelectorAll(".button-color");
          ...
          const domFiltersSize =
            domfilterSettings.querySelectorAll(".button-size");
          ...
          (0, slider_1.setSliderValues)(
            "range-slider-amount",
            "min-amount-mark",
            "max-amount-mark",
            definitions_1.AMOUNT_MIN,
            definitions_1.AMOUNT_MAX
          );
          (0, slider_1.setSliderValues)(
            "range-slider-year",
            "min-year-mark",
            "max-year-mark",
            definitions_1.YEAR_MIN,
            definitions_1.YEAR_MAX
          );
        }
        ...
        showShapeFilters() {
          const domShapeFilterButtons =
            document.querySelectorAll(".button-shape");
          domShapeFilterButtons.forEach((element) => {
            ...
            if (
              this.filters.filterShape.includes(
                definitions_1.eShapes[instanceEShape]
              )
            ) {
          ...
          domColorFilterButtons.forEach((element) => {
            ...
            if (
              this.filters.filterColor.includes(
                definitions_1.eColors[instanceEColor]
              )
            ) {
        ...
        showSizeFilters() {
          const domSizeFilterButtons =
            document.querySelectorAll(".button-size");
          domSizeFilterButtons.forEach((element) => {
            ...
            if (
              this.filters.filterSize.includes(
                definitions_1.eSizes[instanceESize]
              )
            ) {
              domButton.classList.toggle("filters-active-button");
            }
        ...
        showSortingMethod() {
          ...
          const instanceSortingMethod =
            (_a = Object.entries(definitions_1.eSortingMethod).find(
              ([key, val]) => val === this.sortingMethod
            )) === null || _a === void 0
              ? void 0
              : _a[0];
    ...
    /***/ 880: /***/ function (
      ...
      class Tree {
        ...
        applyOrnaments() {
          ...
          const ornamentsArray =
            domTreeWrapper.querySelectorAll(".toy-card-image");
          ...
          this.ornaments.forEach((elem) => {
            ...
            if (domDecorationCardPattern !== null) {
              const domCardImg = domDecorationCardPattern.querySelector(
        ...
        cloneOrnament(domElement, coordX, coordY) {
          ...
          domCloneOrnament.src = `${definitions_1.PATH_TO_TOYS}${String(
        ...
        findOrnamentByNum(num) {
          const domOrnamentsWrapper =
            document.querySelector(".ornaments-wrapper");
          const cardArray =
            domOrnamentsWrapper.querySelectorAll(".decoration-card");
    ...
    /***/ 125: /***/ (__unused_webpack_module, exports) => {
      ...
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.eSortingMethod =
        exports.eSizes =
        exports.eColors =
        exports.eShapes =
        exports.USUAL_TREE_COORD =
        exports.LONG_TREE_COORD =
        exports.IS_SLIDER =
        exports.AMOUNT_OF_BACKGROUNDS =
        exports.AMOUNT_OF_TREES =
        exports.AMOUNT_OF_CARDS =
        exports.MUSIC_PATH =
        exports.YEAR_STEP =
        exports.YEAR_MAX =
        exports.YEAR_MIN =
        ...
        exports.AMOUNT_MAX =
        exports.AMOUNT_MIN =
        exports.CHOSEN_AMOUNT =
        exports.ANIMATION_TIME_200 =
        exports.ANIMATION_TIME_500 =
        exports.CHOSEN_TOYS =
        exports.PATH_TO_BACKGROUNDS =
        exports.PATH_TO_TREES =
        exports.PATH_TO_TOYS =
          void 0;
      ...
      (function (eSortingMethod) {
        eSortingMethod["NAME_AZ"] =
          "\u041F\u043E \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u044E (\u0430-\u044F)";
        eSortingMethod["NAME_ZA"] =
          "\u041F\u043E \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u044E (\u044F-\u0430)";
        eSortingMethod["AMOUNT_MIN_MAX"] =
          "\u041F\u043E \u0433\u043E\u0434\u0443 (\u0432\u043E\u0437\u0440\u0430\u0441\u0442\u0430\u043D\u0438\u044E)";
        eSortingMethod["AMOUNT_MAX_MIN"] =
          "\u041F\u043E \u0433\u043E\u0434\u0443 (\u0443\u0431\u044B\u0432\u0430\u043D\u0438\u044E)";
      })(
        (eSortingMethod =
          exports.eSortingMethod || (exports.eSortingMethod = {}))
      );
    ...
    /***/ 116: /***/ (
      ...
      function createAmountRangeFilter(filters) {
        ...
        if (rangeSlider) {
          (0, slider_1.initializeSlider)(
            "range-slider-amount",
            lowMark,
            highMark,
            definitions_1.AMOUNT_MIN,
            definitions_1.AMOUNT_MAX,
            definitions_1.AMOUNT_STEP
          );
        }
      }
    ...
    /***/ 768: /***/ (__unused_webpack_module, exports) => {
      "use strict";
  ...
  `);
    ...
    /***/ 900: /***/ (__unused_webpack_module, exports) => {
      "use strict";
      ...
      function runSnowflake() {
        ...
        const windowWidth =
          Number(getComputedStyle(domCentralPart).width.slice(0, -2)) || 500;
        const snow_flake = document.createElement("span");
        snow_flake.textContent = "❆";
        snow_flake.classList.add("fa-snowflake");
        snow_flake.style.left = `${coord.x + Math.random() * windowWidth}px`;
        snow_flake.style.animationDuration = Math.random() * 3 + 2 + "s";
        snow_flake.style.opacity = String(Math.random());
        snow_flake.style.fontSize = Math.random() * 10 + 10 + "px";
        domCentralPart.appendChild(snow_flake);
        console.log(snow_flake.style.left);
        setTimeout(() => {
          snow_flake.remove();
        }, 6000);
      }
